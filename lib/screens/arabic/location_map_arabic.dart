...
class LocationMapArabic extends StatefulWidget {
  const LocationMapArabic({super.key, required String title, required String username});
        ...
        children: [
          ...
          PopupMarkerLayerWidget(
            options: PopupMarkerLayerOptions(
              ...
              markers: location_data.arabicData.map((loc) {
              ...
              popupDisplayOptions: PopupDisplayOptions(
                builder: (BuildContext context, Marker marker) {
                  final markerData = location_data.arabicData.firstWhere(
